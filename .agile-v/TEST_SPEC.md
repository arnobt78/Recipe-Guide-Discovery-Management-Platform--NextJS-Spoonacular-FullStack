...
| TC-0020 | C1 | REQ-0020 | perf | business-insights: ≤1 User count query per uncached request | pass |

## Regression Baseline

No automated test suite (per CLAUDE.md). Manual + Sentry observability for C1.
